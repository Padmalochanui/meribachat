    ...
    <>
      <nav className="navbar navbar-expand-lg  mt-4">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav bg-secondary rounded" style={{ marginLeft: "720px" }}>
            <li className="nav-item active">
              ...
              >
                ...
                <div className="bg-primary text-white px-4 rounded">Online</div>
              </Link>
            </li>
            <li className="nav-item">
              ...
              >
                <div className="bg-primary text-white px-4 rounded">Offline</div>
              </Link>
            </li>
          </ul>
        </div>
